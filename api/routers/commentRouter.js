...
const router = express.Router({mergeParams: true}); //üst routtan parametre almak için
...
const { checkCommentExists } =require('../middlewares/database/databaseErrorMiddlewares');
